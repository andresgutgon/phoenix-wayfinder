...
describe('TwoRoutesSameActionController', () => {
  describe('same action (route 1)', () => {
    it('generates correct URL for first route', () => {
      expect(same.url().path).toBe('/two-routes-one-action-1')
      expect(same()).toEqual({
    ...
    it('handles query parameters correctly', () => {
      ...
      expect(same.url(options).path).toBe('/two-routes-one-action-1?page=1&limit=10')
  ...
  describe('same action (route 2)', () => {
    it('generates correct URL for second route', () => {
      expect(same2.url().path).toBe('/two-routes-one-action-2')
    ...
    it('handles query parameters correctly', () => {
      ...
      expect(same2.url(options).path).toBe('/two-routes-one-action-2?search=test')
